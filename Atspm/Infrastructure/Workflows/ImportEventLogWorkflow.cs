...
{
    public class ImportEventLogWorkflow : WorkflowBase<Tuple<Device, FileInfo>, CompressedEventLogBase>
    {
        ...
        public ImportEventLogWorkflow(IServiceScopeFactory services, int batchSize = 50000, int parallelProcesses = 50, CancellationToken cancellationToken = default)
        {
            _services = services;
