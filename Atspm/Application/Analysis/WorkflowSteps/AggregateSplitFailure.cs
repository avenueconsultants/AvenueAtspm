...
namespace Utah.Udot.Atspm.Analysis.WorkflowSteps
{
    ...
    public class AggregateSplitFailure : TransformProcessStepBase<Tuple<Location, IEnumerable<IndianaEvent>>, IEnumerable<ApproachSplitFailAggregation>>
    {
        ...
        {
            IEnumerable<ApproachSplitFailAggregation> enumerable = splitFailureAggregationCalculation(input);
            return Task.FromResult(enumerable);
        }

        public static IEnumerable<ApproachSplitFailAggregation> splitFailureAggregationCalculation(Tuple<Location, IEnumerable<IndianaEvent>> input)
        {
