...
{
    public class AggregateSpeedsBigQueryCommand : Command, ICommandOption<TransferCommandConfiguration>
    {
        public AggregateSpeedsBigQueryCommand() : base("aggregate-speeds", "Aggregate speeds data")
        {
        ...
        public void BindCommandOptions(HostBuilderContext host, IServiceCollection services)
        {
            ...
            services.AddHostedService<AggregateSpeedsToBigQueryService>();
        }
    }
}
