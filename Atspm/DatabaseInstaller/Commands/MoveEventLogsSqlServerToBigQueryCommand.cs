...
// for DatabaseInstaller - DatabaseInstaller.Commands/MoveEventLogsSqlServerToBigQueryCommand.cs
// 
...
{
    public class MoveEventLogsSqlServerToBigQueryCommand : Command, ICommandOption<TransferCommandConfiguration>
    {
        public MoveEventLogsSqlServerToBigQueryCommand() : base("copy-sql-bq", "Copy event logs from SQL Server (ATSPM-EventLogs) to BigQuery")
        {
        ...
        public Option<string> SourceOption { get; set; } = new("--source", "Connection string for the source SQL Server (ATSPM-EventLogs)");
        ...
        public void BindCommandOptions(HostBuilderContext host, IServiceCollection services)
        {
            ...
            services.AddHostedService<MoveEventLogsSqlServerToBigQueryHostedService>();
        }
    }
}
