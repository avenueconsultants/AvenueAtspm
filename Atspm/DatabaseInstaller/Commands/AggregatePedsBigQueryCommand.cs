...
{
    public class AggregatePedsBigQueryCommand : Command, ICommandOption<TransferCommandConfiguration>
    {
        public AggregatePedsBigQueryCommand(): base("aggregate-peds", "Aggregate ped data")
        {
        ...
        public void BindCommandOptions(HostBuilderContext host, IServiceCollection services)
        {
            ...
            services.AddHostedService<AggregatePedestrianToBigQueryService>();
        }
    }
}
