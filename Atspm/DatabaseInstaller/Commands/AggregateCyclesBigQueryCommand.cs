...
{
    public class AggregateCyclesBigQueryCommand : Command, ICommandOption<TransferCommandConfiguration>
    {
        public AggregateCyclesBigQueryCommand(): base("aggregate-cycles", "Aggregate cycle data")
        {
        ...
        public void BindCommandOptions(HostBuilderContext host, IServiceCollection services)
        {
            ...
            services.AddHostedService<CycleAggregationService>();
        }
    }
}
