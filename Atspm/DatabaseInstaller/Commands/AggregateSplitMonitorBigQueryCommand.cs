...
{
    public class AggregateSplitMonitorBigQueryCommand : Command, ICommandOption<TransferCommandConfiguration>
    {
        public AggregateSplitMonitorBigQueryCommand() : base("aggregate-splitmonitor", "Aggregate split monitor data")
        {
        ...
        public void BindCommandOptions(HostBuilderContext host, IServiceCollection services)
        {
            ...
            services.AddHostedService<AggregateSplitMonitorToBigQueryService>();
        }
    }
}
