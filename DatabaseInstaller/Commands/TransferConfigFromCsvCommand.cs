...
namespace DatabaseInstaller.Commands
{
    public class TransferConfigFromCsvCommand : Command
    {
        ...
        public ModelBinder<CopyConfigurationFromCsvOptions> GetOptionsBinder()
        {
            var binder = new ModelBinder<CopyConfigurationFromCsvOptions>();
        ...
        public void BindCommandOptions(HostBuilderContext host, IServiceCollection services)
        {
            ...
            services.AddOptions<CopyConfigurationFromCsvOptions>().BindCommandLine();
            services.AddHostedService<TransferConfigFromCsvHostedService>();
        }

    }

    public class CopyConfigurationFromCsvOptions
    {
